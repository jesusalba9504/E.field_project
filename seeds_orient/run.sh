...
rm substrate.cfg big_seed_zno.xyz seed1.xyz final.xyz final.lmp
...
# atomsk big_seed_zno.xyz -cut below 7 z seed1.xyz
...
atomsk --merge 2 big_seed_zno.xyz substrate.cfg final.xyz
